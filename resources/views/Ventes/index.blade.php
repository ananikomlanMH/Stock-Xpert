    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary custom__link"
                    data-url="{{ \App\Components\Router\Router::route('vente.addForm') }}">Nouveau<i
                ...
                <tr>
                    ...
                    <td class="table_drop_action">
                        ...
                        <div class="dropdown">
                            <ul>
                                <li>
                                    <a href="{{ \App\Components\Router\Router::route('vente.print', ['id' => $item->id]) }}" target="_blank" data-turbolinks="false"><i class="fi-rr-print"></i> Imprimer</a>
                                </li>
                                <li>
                                    <form action="{{ \App\Components\Router\Router::route('vente.delete', ['id' => $item->id]) }}" method="post" class="deleteForm">
