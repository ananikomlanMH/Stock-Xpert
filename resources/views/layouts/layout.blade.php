...
@if(!empty($_SESSION["id"]) && mode_production)
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li @class(['active showMenu' => str_starts_with(\App\Components\Router\Router::currentRoute(), 'settings')])>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ \App\Components\Router\Router::route('settings.utilisateur') }}">Utilisateurs</a>
                    </li>
                    <li><a href="{{ \App\Components\Router\Router::route('settings.configuration') }}">Configuration</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <div class="profile-details">
                    ...
                    <i class='fi-rr-sign-out-alt log_out' id="JSlogout__user"
                       data-url="{{ \App\Components\Router\Router::route('logout') }}"
...
@endif
<section class="home-section" @if(empty($_SESSION["id"])) style="left: 0;width: 100%;" @endif>
    @yield('content')
</section>
