...
<?php $__env->startSection('content'); ?>
    <div class="link d-flex gap-1" style="width: 100%;display:flex;align-items: center">Dépenses <div style="background:#e2e2e2;width: 1px;height: 30px;"></div><span class="good-span"><?php echo e(\App\Helpers\NumberHelper\NumberHelper::CurrencyFormat($total)); ?></span></div>
    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary JS_Call_Url_Get_Form"
                    data-url="<?php echo e(\App\Components\Router\Router::route('depense.addForm')); ?>">Nouveau<i
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                ...
                <th><?php echo $tableHelper->th('motif'); ?></th>
                ...
                <tr>
                    ...
                    <td class="table_drop_action">
                        ...
                        <div class="dropdown">
                            <ul>
                                <li>
                                    <a href="<?php echo e(\App\Components\Router\Router::route('depense.editForm', ['id' => $item->id])); ?>" class="JS_Call_Url_Get_Form"><i class="fi-rr-edit"></i> Editer</a>
                                </li>
                                <li>
                                    <form action="<?php echo e(\App\Components\Router\Router::route('depense.delete', ['id' => $item->id])); ?>" method="post" class="deleteForm">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\StockXpert\resources\views/Depenses/index.blade.php ENDPATH**/ ?>