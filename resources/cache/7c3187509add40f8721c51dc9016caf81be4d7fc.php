    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary custom__link"
                    data-url="<?php echo e(\App\Components\Router\Router::route('appro.addForm')); ?>">Nouveau<i
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                ...
                <th><?php echo $tableHelper->th('fournisseur'); ?></th>
                ...
                <tr>
                    ...
                    <td class="table_drop_action">
                        ...
                        <div class="dropdown">
                            <ul>
                                <li>
                                    <a href="<?php echo e(\App\Components\Router\Router::route('appro.print', ['id' => $item->id])); ?>" target="_blank" data-turbolinks="false"><i class="fi-rr-print"></i> Imprimer</a>
                                </li>
                                <li>
                                    <form action="<?php echo e(\App\Components\Router\Router::route('appro.delete', ['id' => $item->id])); ?>" method="post" class="deleteForm">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\StockXpert\resources\views/Approvisionnements/index.blade.php ENDPATH**/ ?>