...
<div class="login_container">
    <div class="login">
        <form action="<?php echo e(\App\Components\Router\Router::route('login.auth')); ?>" class="custom__form" id="login__form" method="post">
            <h1 class="mb-10"><img src="/vendors/images/logo.svg" alt="logo" class="icon"></h1>

            <p class="mb-20"></p>
            <?php echo $form->getInput("text", null, "username", "Username", null, null , "noEmpty", 200); ?>

            <?php echo $form->getInput("password", null, "password", "Password", null, null , "noEmpty", 200); ?>
...
</html><?php /**PATH C:\wamp64\www\StockXpert\resources\views/Auth/login.blade.php ENDPATH**/ ?>