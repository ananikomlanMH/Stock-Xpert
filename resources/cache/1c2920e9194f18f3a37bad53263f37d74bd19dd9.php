    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary JS_Call_Url_Get_Form"
                    data-url="<?php echo e(\App\Components\Router\Router::route('settings.categorie.addForm')); ?>">Nouveau<i
            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="d-flex gap-1">
                        <a href="<?php echo e(\App\Components\Router\Router::route('settings.categorie.editForm', ['id' => $item->id])); ?>" class="link__table JS_Call_Url_Get_Form"><i class="fi-rr-edit"></i> Editer</a>

                        <form action="<?php echo e(\App\Components\Router\Router::route('settings.categorie.delete', ['id' => $item->id])); ?>" method="post" class="deleteForm">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\StockXpert\resources\views/settings/CategoriesArticle/categorie.blade.php ENDPATH**/ ?>