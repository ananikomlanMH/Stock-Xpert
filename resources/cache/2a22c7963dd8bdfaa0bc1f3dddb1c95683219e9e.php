...
<?php $__env->startSection('content'); ?>
    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <a target="_blank" data-turbolinks="false" href="<?php echo e(\App\Components\Router\Router::route('stock.print')); ?>" class="second-primary">Imprimer <i style="margin-left: 8px;" class="fi-rr-print"></i></a>
            <button class="btn-primary JS_Call_Url_Get_Form"
                    data-url="<?php echo e(\App\Components\Router\Router::route('stock.addForm')); ?>">Nouveau<i
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                <th class="w-50"></th>
                <th><?php echo $tableHelper->th('articles_id'); ?></th>
                <th>Catégorie</th>
                <th>Prix</th>
                <th><?php echo $tableHelper->th('qte_alerte'); ?></th>
                <th><?php echo $tableHelper->th('qte_stock'); ?></th>
                <th class="w-50"></th>
            </tr>
            </thead>
            <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="<?php echo \Illuminate\Support\Arr::toCssClasses(['alert-row' => $item->qte_alerte >= $item->qte_stock]) ?>">
                    <td class="img">
                        <div>
                    ...
                    <td><?php echo e(\App\Helpers\NumberHelper\NumberHelper::CurrencyFormat2($item->qte_alerte)); ?></td>
                    <td><?php echo e(\App\Helpers\NumberHelper\NumberHelper::CurrencyFormat2($item->qte_stock)); ?></td>
                    <td class="table_drop_action">
                        <i class='icon fi-rr-menu-dots-vertical'></i>
                        <div class="dropdown">
                            <ul>
                                <li>
                                    <a href="<?php echo e(\App\Components\Router\Router::route('stock.editForm', ['id' => $item->id])); ?>" class="JS_Call_Url_Get_Form"><i class="fi-rr-edit"></i> Editer</a>
                                </li>
                                <li>
                                    <form action="<?php echo e(\App\Components\Router\Router::route('stock.delete', ['id' => $item->id])); ?>" method="post" class="deleteForm">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\StockXpert\resources\views/Stocks/index.blade.php ENDPATH**/ ?>