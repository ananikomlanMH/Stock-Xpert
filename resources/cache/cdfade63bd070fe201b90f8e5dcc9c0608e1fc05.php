...
<?php if(!empty($_SESSION["id"]) && mode_production): ?>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="">
                    ...
                    <span class="link_name">Bon Commande</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="#">Bon Commande</a></li>
                </ul>
            </li>
            ...
            <li class="<?php echo \Illuminate\Support\Arr::toCssClasses(['active showMenu' => str_starts_with(\App\Components\Router\Router::currentRoute(), 'settings')]) ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="<?php echo e(\App\Components\Router\Router::route('settings.utilisateur')); ?>">Utilisateurs</a>
                    </li>
                    <li><a href="<?php echo e(\App\Components\Router\Router::route('settings.configuration')); ?>">Configuration</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <div class="profile-details">
                    ...
                    <i class='fi-rr-sign-out-alt log_out' id="JSlogout__user"
                       data-url="<?php echo e(\App\Components\Router\Router::route('logout')); ?>"
...
<?php endif; ?>
<section class="home-section" <?php if(empty($_SESSION["id"])): ?> style="left: 0;width: 100%;" <?php endif; ?>>
