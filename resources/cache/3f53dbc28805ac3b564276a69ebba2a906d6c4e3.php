...
<?php $__env->startSection('title', 'Ventes Direct'); ?>

<?php $__env->startSection('content'); ?>
    <div class="link">Ventes Direct</div>
    ...
    <div class="filter-form mt-25">
        ...
        <div class="right-content d-flex gap-1">
            ...
            <button class="btn-primary custom__link"
                    data-url="<?php echo e(\App\Components\Router\Router::route('vente.addForm')); ?>">Nouveau<i
    ...
    <div class="table-list table-bordered table-striped ">
        <table>
            ...
            <tr>
                ...
                <th><?php echo $tableHelper->th('client'); ?></th>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e(\App\Helpers\NumberHelper\NumberHelper::CurrencyFormat($item->total())); ?></td>
                    <td class="table_drop_action">
                        <i class='icon fi-rr-menu-dots-vertical'></i>
                        <div class="dropdown">
                            <ul>
                                <li>
                                    <a href="<?php echo e(\App\Components\Router\Router::route('vente.print', ['id' => $item->id])); ?>" target="_blank" data-turbolinks="false"><i class="fi-rr-print"></i> Imprimer</a>
                                </li>
                                <li>
                                    <form action="<?php echo e(\App\Components\Router\Router::route('vente.delete', ['id' => $item->id])); ?>" method="post" class="deleteForm">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\StockXpert\resources\views/Ventes/index.blade.php ENDPATH**/ ?>